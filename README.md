...
This is Lior's personal fork of the [Superpowers](https://github.com/obra/superpowers) Claude Code plugin, seeded from version **6.1.0** as distributed via the official marketplace `anthropics/claude-plugins-official` at commit `a98c5dfc`. It has since been merged up to upstream **6.4.1**.
...
## Customizations vs. upstream 6.4.1
