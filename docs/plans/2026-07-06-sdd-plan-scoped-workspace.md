...
**Files:**
- Create: `docs/specs/2026-07-06-sdd-plan-scoped-workspace-eval-notes-red.md`
...
`docs/specs/2026-07-06-sdd-plan-scoped-workspace-eval-notes-red.md` with exactly these sections, filled from the artifacts:
...
```bash
git add docs/specs/2026-07-06-sdd-plan-scoped-workspace-eval-notes-red.md
...
- Create: `docs/specs/2026-07-06-sdd-plan-scoped-workspace-eval-results.md`
- Delete: `docs/specs/2026-07-06-sdd-plan-scoped-workspace-eval-notes-red.md` (content folds into the results doc)
...
Create `docs/specs/2026-07-06-sdd-plan-scoped-workspace-eval-results.md` with exactly these sections (fill with real data):
...
```bash
git rm -q docs/specs/2026-07-06-sdd-plan-scoped-workspace-eval-notes-red.md
git add docs/specs/2026-07-06-sdd-plan-scoped-workspace-eval-results.md
