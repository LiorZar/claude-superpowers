...
This is a fork. See the **Fork Maintenance** section in [CLAUDE.md](CLAUDE.md) for the
project-local documentation layout (`docs/plans/`, `docs/specs/`) that upstream merges
must preserve.
